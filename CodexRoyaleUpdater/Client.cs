...
namespace CodexRoyaleUpdater
{
    ...
    //move to appsettings.json
        public string myClanTag = "#8CYPL8R";
        public string clanTag = "#2YLC08L";
        public string myPlayerTag = "#29PGJURQL";
        public string randomPlayerTag = "#9QGPC82Y0";
        ...
        public static string codexBearerToekn = "071aa839-8e03-4aa1-966e-fe547284f2e9";
